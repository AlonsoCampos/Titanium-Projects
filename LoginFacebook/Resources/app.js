   ...
   //function to use HTTP to connect to a web server and transfer the data. 
              ...
              sendit.onload = function(){ 
                     ...
                     for( var i=0; i<json.length; i++){ 
	    					...
	    					objName: 'row',
	    					id:json[i].idEventos, // custom property, useful for determining the row during events
							height:110
							});
							row.desc = "Este es el id "+json[i].idEventos;
							row.info =json[i].titulo;
							row.desc = json[i].descripcion;
